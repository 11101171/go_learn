...
func init() {
	flag.StringVar(&hostIp, "h", "120.26.78.245", "The remote host ip.")
	flag.StringVar(&port, "port", "22", "The remote host port.")
	flag.StringVar(&userNmae, "u", "souche", "The user name login host.")
	flag.StringVar(&passWord, "p", "pwd!Z@X@souche2013", "Log on to the host password.")
	flag.StringVar(&iManUser, "iManu", "", "The user name login iMan.")
	flag.StringVar(&iManPassword, "iManp", "", "Login iMan's password.")
	flag.StringVar(&shellCmd, "c", "uptime;whoami;ls;cd /home;", "To perform a shell command.")
	flag.BoolVar(&debugSwitch, "d", true, "The debug switch.")
}
func main() {
	flag.Parse()
